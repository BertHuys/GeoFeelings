...
define(['Modernizr', 'testStyles', 'createElement'], function(Modernizr, testStyles, createElement) {
  Modernizr.addTest('unicoderange', function() {
    ...
    return Modernizr.testStyles('@font-face{font-family:"unicodeRange";src:local("Arial");unicode-range:U+0020,U+002E}#modernizr.js span{font-size:20px;display:inline-block;font-family:"unicodeRange",monospace}#modernizr.js .mono{font-family:monospace}', function(elem) {
